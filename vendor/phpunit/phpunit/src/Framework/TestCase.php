...
abstract class TestCase extends Assert implements Reorderable, SelfDescribing, Test
{
    ...
    {
        $message = 'This tests has an invalid dependency';
    ...
    private function compareGlobalStateSnapshots(Snapshot $before, Snapshot $after): void
    {
        ...
        if ($this->backupStaticProperties) {
            $this->compareGlobalStateSnapshotPart(
                ...
                "--- Static properties before the tests\n+++ Static properties after the tests\n",
            );
        }
    }
    ...
    private function compareGlobalStateSnapshotPart(array $before, array $after, string $header): void
    {
        if ($before !== $after) {
            ...
            Event\Facade::emitter()->testConsideredRisky(
                $this->valueObjectForEvents(),
                'This tests modified global state but was not expected to do so' . PHP_EOL .
                trim(
                    $differ->diff(
    ...
    /**
     * Creates a tests stub for the specified interface or class.
     *
     * @template RealInstanceType of object
     *
     * @param class-string<RealInstanceType> $type
    ...
    /**
     * Creates (and configures) a tests stub for the specified interface or class.
     *
     * @template RealInstanceType of object
     *
     * @param class-string<RealInstanceType> $type
