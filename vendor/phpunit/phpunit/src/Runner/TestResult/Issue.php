...
final class Issue
{
    ...
    /**
     * @var non-empty-array<non-empty-string, array{tests: Test, count: int}>
     */
    ...
    /**
     * @return non-empty-array<non-empty-string, array{tests: Test, count: int}>
     */
    ...
    public function triggeredInTest(): bool
    {
        return count($this->triggeringTests) === 1 &&
               $this->file === $this->triggeringTests[array_keys($this->triggeringTests)[0]]['tests']->file();
    }
}
