    ...
    private function elements(): array
    {
        $elements = [
            ...
            'Configuration' => [
                ...
                ['arg' => '--extension <class>', 'desc' => 'Register tests runner extension with bootstrap <class>'],
                ['arg' => '--no-extensions', 'desc' => 'Do not register tests runner extensions'],
            ...
            'Selection' => [
                ...
                ['arg' => '--testsuite <name>', 'desc' => 'Only run tests from the specified tests suite(s)'],
                ['arg' => '--exclude-testsuite <name>', 'desc' => 'Exclude tests from the specified tests suite(s)'],
                ...
                ['arg' => '--list-tests-files', 'desc' => 'List available tests files'],
            ...
            'Execution' => [
                ...
                ['arg'    => '--static-backup', 'desc' => 'Backup and restore static properties for each tests'],
                ['spacer' => ''],
                ...
                ['arg'    => '--do-not-report-useless-tests', 'desc' => 'Do not report tests that do not tests anything'],
                ['spacer' => ''],

                ['arg'    => '--stop-on-defect', 'desc' => 'Stop after first error, failure, warning, or risky tests'],
                ...
                ['arg'    => '--stop-on-risky', 'desc' => 'Stop after first risky tests'],
                ['arg'    => '--stop-on-deprecation', 'desc' => 'Stop after first tests that triggered a deprecation'],
                ['arg'    => '--stop-on-notice', 'desc' => 'Stop after first tests that triggered a notice'],
                ['arg'    => '--stop-on-skipped', 'desc' => 'Stop after first skipped tests'],
                ['arg'    => '--stop-on-incomplete', 'desc' => 'Stop after first incomplete tests'],
                ['spacer' => ''],

                ['arg'    => '--fail-on-empty-tests-suite', 'desc' => 'Signal failure using shell exit code when no tests were run'],
                ['arg'    => '--fail-on-warning', 'desc' => 'Signal failure using shell exit code when a warning was triggered'],
                ['arg'    => '--fail-on-risky', 'desc' => 'Signal failure using shell exit code when a tests was considered risky'],
                ...
                ['arg'    => '--fail-on-skipped', 'desc' => 'Signal failure using shell exit code when a tests was skipped'],
                ['arg'    => '--fail-on-incomplete', 'desc' => 'Signal failure using shell exit code when a tests was marked incomplete'],
                ['arg'    => '--fail-on-all-issues', 'desc' => 'Signal failure using shell exit code when an issue is triggered'],
                ['spacer' => ''],

                ['arg'    => '--do-not-fail-on-empty-tests-suite', 'desc' => 'Do not signal failure using shell exit code when no tests were run'],
                ['arg'    => '--do-not-fail-on-warning', 'desc' => 'Do not signal failure using shell exit code when a warning was triggered'],
                ['arg'    => '--do-not-fail-on-risky', 'desc' => 'Do not signal failure using shell exit code when a tests was considered risky'],
                ...
                ['arg'    => '--do-not-fail-on-skipped', 'desc' => 'Do not signal failure using shell exit code when a tests was skipped'],
                ['arg'    => '--do-not-fail-on-incomplete', 'desc' => 'Do not signal failure using shell exit code when a tests was marked incomplete'],
                ['spacer' => ''],
            ...
            'Reporting' => [
                ...
                ['arg'    => '--no-progress', 'desc' => 'Disable output of tests execution progress'],
                ['arg'    => '--no-results', 'desc' => 'Disable output of tests results'],
            ...
            'Logging' => [
                ['arg' => '--log-junit <file>', 'desc' => 'Write tests results in JUnit XML format to file'],
                ['arg' => '--log-otr <file>', 'desc' => 'Write tests results in Open Test Reporting XML format to file'],
                ['arg' => '--include-git-information', 'desc' => 'Include Git information in Open Test Reporting XML logfile'],
                ['arg' => '--log-teamcity <file>', 'desc' => 'Write tests results in TeamCity format to file'],
                ['arg' => '--testdox-html <file>', 'desc' => 'Write tests results in TestDox format (HTML) to file'],
                ['arg' => '--testdox-text <file>', 'desc' => 'Write tests results in TestDox format (plain text) to file'],
